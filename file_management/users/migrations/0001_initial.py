# Generated by Django 2.1.7 on 2020-09-04 17:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('one_to_one_share_uid', models.TextField(blank=True, max_length=1500, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_path', models.CharField(blank=True, max_length=255)),
                ('file', models.FileField(blank=True, null=True, upload_to='', verbose_name='file_name')),
                ('lates_file', models.CharField(blank=True, max_length=255)),
                ('file_size', models.PositiveIntegerField(blank=True)),
                ('file_format', models.CharField(blank=True, max_length=255)),
                ('old_files', models.CharField(blank=True, max_length=50000, null=True)),
                ('doc_company', models.CharField(blank=True, max_length=255)),
                ('doc_date', models.DateTimeField(auto_now_add=True)),
                ('doc_currency', models.CharField(blank=True, max_length=100)),
                ('doc_amount', models.CharField(blank=True, max_length=10)),
                ('doc_number', models.PositiveIntegerField(blank=True)),
                ('doc_customer_number', models.CharField(blank=True, max_length=255)),
                ('doc_search_key', models.CharField(blank=True, max_length=100)),
                ('doc_notice', models.CharField(blank=True, max_length=100)),
                ('doc_dated', models.CharField(editable=False, max_length=100)),
                ('status', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rel_user_file', to=settings.AUTH_USER_MODEL)),
            ],
            options={
